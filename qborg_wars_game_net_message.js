...
var _QBorgGameNetMessages = function (json_params)
{
	...
	this.GetNickNameMessage.data = {
		...
		requested_player_id: json_params.id
	};
...
_QBorgGameNetMessages.prototype.setID = function (json_params)
{
	this.GetNickNameMessage.data.requested_player_id = json_params.id;
